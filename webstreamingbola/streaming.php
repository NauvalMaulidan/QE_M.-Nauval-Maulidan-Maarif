    ...
    <div class="page-section border-top">
      <div class="container">
        <div class="text-center wow fadeInUp">
          <h2 class="title-section" style="margin-top: 10%;">Streaming</h2>
          <div class="divider mx-auto"></div>
        </div>
       <iframe width="1150" height="560" style="align-content: center;" src="https://www.youtube.com/embed/Jc4_0Rq4TD0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
